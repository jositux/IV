...
export function VideoLandingPage() {
  ...
  return (
    <div className="min-w-full">
            ...
            <div className="relative z-10">
              <div className="relative cursor-pointer group" onClick={() => setIsVideoOpen(true)}>
                <div className="relative rounded-lg overflow-hidden shadow-2xl">
                  <img src="/professional-woman-in-orange-sweater-presenting-on.jpg" alt="Video preview" className="w-full h-auto" />
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Our advanced reasoning model crafts "turns human thinking" scripts, scenes, and narration tailored to
                  your AGI-use, on-brand, voicing, required from you.
                </p>
                <div className="bg-purple-50 p-4 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="overflow-hidden cursor-pointer hover:shadow-lg transition group">
              <div className="relative h-64 bg-gradient-to-br from-purple-300 to-purple-500">
                <img src="/happy-professional-woman-on-laptop-with-purple-lig.jpg" alt="Video example" className="w-full h-full object-cover" />
            ...
            <Card className="overflow-hidden cursor-pointer hover:shadow-lg transition group">
              <div className="relative h-48 bg-gradient-to-br from-orange-300 to-orange-500">
                <img src="/person-in-yellow-jacket-with-coffee-outdoors.jpg" alt="Video example" className="w-full h-full object-cover" />
              </div>
              <CardContent className="pt-6">
            ...
            <Card className="overflow-hidden cursor-pointer hover:shadow-lg transition group">
              <div className="relative h-48 bg-gradient-to-br from-blue-300 to-blue-500">
                <img src="/professional-presenting-with-screen-behind.jpg" alt="Video example" className="w-full h-full object-cover" />
              </div>
              <CardContent className="pt-6">
            ...
            <Card className="overflow-hidden cursor-pointer hover:shadow-lg transition group">
              <div className="relative h-48 bg-gradient-to-br from-green-300 to-green-500">
                <img src="/outdoor-business-discussion.jpg" alt="Video example" className="w-full h-full object-cover" />
              </div>
              <CardContent className="pt-6">
      ...
      >
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20 text-white">
              <CardContent className="pt-6">
                <h3 className="text-xl font-bold mb-2">Studio Members Only / Studio Boost</h3>
                <p className="text-sm text-purple-200 mb-6">
                  For agencies and enterprises with consistent, high-volume content needs
                </p>
                <div className="mb-6">
                  <div className="text-4xl font-bold mb-1">$499</div>
                  <div className="text-sm text-purple-200">Per user/month</div>
                </div>
                <div className="text-center py-4 bg-white/5 rounded mb-6">
                  <div className="text-3xl font-bold">600 Credits</div>
                  <div className="text-sm text-purple-200">Or customize your plan</div>
                </div>
                <ul className="space-y-3 text-sm mb-6">
      ...
      {/* Footer */}
      <footer className="bg-[#0a0520] text-white py-12 px-6">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400 mb-4">
                Learn more about AI in your video content creation. Build AI-fueled, customizable content in minutes,
                not days. The future of corporate communications starts here.
              </p>
            </div>
            <div>
              ...
              <div className="flex gap-2">
                <input
                  type="email"
                  placeholder="Email"
                  className="flex-1 px-4 py-2 rounded bg-white/10 border border-white/20 text-white placeholder:text-gray-400"
                />
          ...
          <div className="border-t border-white/10 pt-8 flex flex-wrap justify-between items-center text-sm text-gray-400">
