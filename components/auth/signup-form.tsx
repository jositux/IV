...
export function SignupForm() {
  ...
  const handleAuth0Signup = async (e: React.FormEvent) => {
    e.preventDefault()
    ...
    // Construir la URL de autorización de Auth0 con screen_hint=signup
  ...
  return (
    <form onSubmit={handleAuth0Signup} className="space-y-4">
